...
<head>
    ...
    <style>
        html, body {
            background:#fff url("{{ asset('img/welcome.png') }}") no-repeat center center;
            color: #fff;
...
<body>
<div id="app">
    <nav class="navbar navbar-static-top own-bar">
    ...
    <div class="content flex-center position-ref">
        <div class="title m-b-md center">
            Welcome To The Show Hub!
        </div>
    </div>
</div>
